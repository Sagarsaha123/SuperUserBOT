...
async def run_async_clients():
    ...
    try:
        ...
        pass
    try:
        await app.join_chat("AmBotYT")
        await app.join_chat("AM_YTSupport")
        await app.join_chat("AbhiModszYT_Return")
        await app.join_chat("AM_Unfban")
        await app.join_chat("Logs_Gban")
        await app.join_chat("About_AMBot")
        await app.join_chat("Fbans_Logs")
        await app.join_chat("SpicyEmpireSupport")
        await app.join_chat("SpicyEmpire")
        await app.join_chat("SpicyEmpireFban")
    except:
        pass
    if SESSION_STRING:
    ...
    try:
        ...
        await asyncio.sleep(1)
        await app.send_message("BotFather", "Super Userbot")
