                ...
                button = [
                    [
                        InlineKeyboardButton(
                            "💥 Deploy Super Userbot ✨",
                            url=f"https://github.com/AbhiModszYT/SuperUserBOT"
                        )
                    ]
                ]
                    ...
                    results=[
                        (
                            InlineQueryResultPhoto(
                                photo_url=f"https://telegra.ph/file/7df0a69f1a37ce4259f2e.png",
                                title="🥀 Super Userbot ✨",
                                thumb_url=f"https://telegra.ph/file/7df0a69f1a37ce4259f2e.png",
                                description=f"🌷 Deploy Your Own SuperUser 🌿...",
                                caption=f"<b>🥀 Welcome » To » Super\n✅ Userbot {__version__} ✨...</b>",
                        ...
                        (
                            InlineQueryResultArticle(
                                ...
                                input_message_content=InputTextMessageContent(
                                    f"||**🥀 Please, Deploy Your Own Super Userbot❗...\n\nRepo:** <i>https://github.com/AbhiModszYT/SuperUserBOT/</i>||"
                                ),
                            )
                        )
                    ],
